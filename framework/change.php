...
<section class="row" id="forms">
	<h2 class="fontface">Password Not Secure Enough?</h2>
       <form action="pwd1.php" method="POST" class="col col_7">
 
<fieldset>	
                        <legend>Change Password</legend>
            <div>
                <label>Current Passowrd</label>
                <input type="password" name="oldp" class="box_shadow" />

            </div>
            <div>
                <label>New Password</label>
                <input type="password" name="newp" class="box_shadow" />
            </div>
<div>
                <label>Confirm New Password</label>
                <input type="password" name="cnewp" class="box_shadow" />
            </div>
