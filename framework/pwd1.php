...
$oldpass=$_POST["oldp"];
$newpass=$_POST["newp"];
$cnewpass=$_POST["cnewp"];
if($newpass==$cnewpass)
{
$tempid=$_SESSION["id"];
$conn = new PDO ("mysql:host=$dbhost;dbname=$dbname",$dbuser,$dbpass);

$sql = "SELECT * FROM userlogin WHERE id=$tempid";
$q=$conn->query($sql);
/*
while($r=$q->fetch())
{
...
$sql2 = "UPDATE userlogin SET password=:password WHERE id=:id";
$q2=$conn2->prepare($sql2);
Iif($q2->execute(array(':password'=>$newpass,
			':id'=>$tempid)))
{
echo "passowrd change";
}
}
else {
